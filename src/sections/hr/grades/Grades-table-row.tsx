...
export default function GradesTableRow({ row, onEditRow, onDeleteRow, deleteLoading }: Props) {
  const { gradeName, avatarUrl, active, approvalStatusColor, activeColor, approvalStatus } = row;
  ...
  return (
    <>
      <TableRow hover>
        ...
        >
          <Avatar alt={gradeName} src={`${IMAGE_BASE}/${avatarUrl}`} sx={{ mr: 2 }} />
          <ListItemText primary={gradeName} primaryTypographyProps={{ typography: 'body2' }} />
        </TableCell>
